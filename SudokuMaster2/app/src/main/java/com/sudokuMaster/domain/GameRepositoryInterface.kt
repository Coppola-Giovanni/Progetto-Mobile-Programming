...
interface GameRepositoryInterface {
    ...
    suspend fun createNewGameAndSave(difficulty: DifficultyLevel): GameSession

    suspend fun getLatestUnfinishedGameSession(): GameSession?
    ...
    suspend fun updateGameNodeAndSave(puzzle: SudokuPuzzle): GameSession
