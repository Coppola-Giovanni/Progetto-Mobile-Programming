...
class ActiveGameLogic (
    ...
    private val gameRepo: IGameRepository,                      //qui lui utilizza un filesystem per la persistenza questi termini vanno sostituiti con parametri per il database
    private val statsRepo: IStatisticsRepository,               //questo è per le statistiche salvate
